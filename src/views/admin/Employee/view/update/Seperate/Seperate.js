...
export default ({ datas }) => {
  ...
  const onUpdate = (info) => {
    ...
    console.log(datas);
    // updateUserRole({ variables: { id: datas.account._id, roles: roles } });
    // updateEmployeeInfo({
    //   variables: { id: datas.employee_info._id, input: info.employeeinfo },
    // });

    // updateEmployee({ variables: { id: datas._id, input: info.employee } });
  };
