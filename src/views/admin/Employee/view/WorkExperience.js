        ...
        <Fade left>
          ...
          >
            <CardHeader
              ...
              action={ <UpdateWorkExperienceInfo style={{ cursor: "pointer" }} data={employeeInfo} /> }
            />
            <Divider />
            <Box p={3}>
              <Table>
          ...
          <Fade right>
            ...
            >
              <CardHeader
                ...
                action={ <UpdateReason style={{ cursor: "pointer" }} data={employeeInfo} /> }
              />
              <Divider />
              <Box p={3}>
        ...
        <Grid item xs={12}>
          <Fade right>
            ...
            >
              <CardHeader
                title="Reference"
                action={ <UpdateImmediateSuperior style={{ cursor: "pointer" }} data={employeeInfo} /> }
              />
              <Divider />
              <Box p={3}>
                <Table>
